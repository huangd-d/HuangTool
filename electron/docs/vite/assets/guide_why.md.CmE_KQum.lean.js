import{M as e,_ as t,c as n,ct as r,d as i,h as a,z as o}from"./chunks/runtime-core.esm-bundler.Di_optew.js";var s=`<svg viewBox="0 0 1896 1071" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,c=`<svg viewBox="0 0 1896 1071" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,l=JSON.parse(`{"title":"Why Vite","description":"","frontmatter":{},"headers":[],"relativePath":"guide/why.md","filePath":"guide/why.md"}`),u=Object.assign({name:`guide/why.md`},{setup(l){return(l,u)=>{let d=o(`svg-image`);return e(),i(`div`,null,[u[0]||=a("",10),t(d,{svg:r(s)},null,8,[`svg`]),u[1]||=n(`p`,null,[n(`em`,null,`In a bundle-based dev server, the entire application is bundled before it can be served.`)],-1),t(d,{svg:r(c)},null,8,[`svg`]),u[2]||=a("",14)])}}});export{l as __pageData,u as default};