...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  dbConnections: () => ipcRenderer.invoke('db-connections'),
  dbSavedConnections: () => ipcRenderer.invoke('db-saved-connections'),
  dbSaveConnection: (config) => ipcRenderer.invoke('db-save-connection', config),
  dbDeleteConnection: (id) => ipcRenderer.invoke('db-delete-connection', id),
  dbCall: (connectionId, method, ...args) => ipcRenderer.invoke('db-call', connectionId, method, ...args),
  // 窗口控制
